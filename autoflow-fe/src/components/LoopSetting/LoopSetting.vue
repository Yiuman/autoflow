...
<template>
    <div class="loop-setting">
        <AForm :model="data" layout="vertical">
            <AFormItem :label="I18N('loop.loopCardinality','loopCardinality')"
            ...
            <AFormItem :label="I18N('loop.collectionString','collectionString')" field="collectionString">
            ...
            <AFormItem :label="I18N('loop.completionCondition','completionCondition')"
