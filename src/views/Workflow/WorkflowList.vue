...
<template>
    <div class="workflow-container">
        ...
        <div class="workflow-list">
                    ...
                    <ADropdown trigger="hover">
                        ...
                        <template #content>
                            <div class="workflow-card-operator-box">
                                ...
                                <div class="workflow-card-operator-item" @click="exportWorkflow(workflow)">导出工作流文件</div>
            ...
            <AModal v-model:visible="uploadFormVisible" modal-class="upload-workflow-modal" @cancel="resetInstance"
                draggable :footer="false">
                <template #title>
                    导入工作流文件创建
                </template>
                <AUpload :auto-upload="false" :show-file-list="false" draggable @change="uploadWorkflowJson">
                ...
                <template v-if="uploadExistsed">
                    <div class="upload-repeat-alert">
                        ...
                        或 <AButton size="mini" type="primary" @click="() => saveUploadWorkflow(false)">创建</AButton>
                        新的工作流
                    </div>
                </template>
            </AModal>
