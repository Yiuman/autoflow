...
function getContainer(): HTMLElement {
  console.warn(' document.getElementById(\'pluginsContainer\') as HTMLElement', document.getElementById('pluginsContainer') as HTMLElement)
  return document.getElementById('pluginsContainer') as HTMLElement
}
